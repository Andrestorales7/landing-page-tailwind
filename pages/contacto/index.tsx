        ...
        <section className="bg-white py-16">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl">
              {/* Leaflet Map */}
              <div id="map-container" className="h-[450px] w-full"></div>

              {/* Fallback map link for when JS is disabled */}
              <noscript>
                <div className="text-center py-16 bg-gray-100">
                  <p className="mb-4">Para visualizar el mapa, por favor habilite JavaScript en su navegador.</p>
                  <a
