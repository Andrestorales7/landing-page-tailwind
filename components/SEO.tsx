...
export default function SEO({
  ...
  image = 'https://www.cmpagro.com.py/favicons/og-image.png',
  ...
  return (
    <Head>
      ...
      {/* Open Graph - Updated with better image handling */}
      ...
      {/* Twitter - Enhanced for better display */}
      ...
      {/* Favicons - Complete set with proper order and types */}
