...
const noticiasData: Noticia[] = [
    {
        ...
        imagen: "/images/noticias/tecnologia-precision.jpg",
      ...
      },
      {
        ...
        imagen: "/images/noticias/cultivos-organicos.jpg",
      ...
      },
      {
        ...
        imagen: "/images/noticias/tendencias-agroindustria.jpg",
      ...
      {
        id: 4,
        titulo: "Avances en forrajes resistentes a la sequía",
        descripcion: "Investigaciones demuestran resultados prometedores en variedades que pueden sobrevivir con menos recursos hídricos.",
        imagen: "/images/noticias/forrajes-sequia.jpg",
        categoria: "Ganadería",
        autor: "Laura Mendoza",
        fecha: "28/10/2023",
        tiempoLectura: 4
      },
      {
        ...
        imagen: "/images/noticias/control-biologico.jpg",
      ...
      },
      {
        ...
        imagen: "/images/noticias/manejo-agua.jpg",
      ...
      {
        id: 7,
        titulo: "Feria Nacional de Maquinaria Agrícola 2023",
        descripcion: "Todo lo que necesitas saber sobre el evento que reunirá las últimas innovaciones del sector en Encarnación.",
        imagen: "/images/noticias/feria-maquinaria.jpg",
        categoria: "Eventos",
      ...
      },
      {
        ...
        imagen: "/images/noticias/agroforestales.jpg",
        categoria: "Sostenibilidad",
        autor: "Ana López",
        fecha: "3/10/2023",
        tiempoLectura: 7
      },
      {
        ...
        imagen: "/images/noticias/riego-goteo.jpg",
        categoria: "Innovación",
      ...
      {
        id: 10,
        titulo: "Congreso Internacional de Agronomía Tropical",
        descripcion: "Paraguay será sede del evento que reunirá expertos de toda Latinoamérica para discutir desafíos futuros.",
        imagen: "/images/noticias/congreso-agronomia.jpg",
        categoria: "Eventos",
        autor: "Carmen Acosta",
        fecha: "20/9/2023",
        tiempoLectura: 6
      },
      {
        ...
        imagen: "/images/noticias/control-malezas.jpg",
        categoria: "Horticultura",
        autor: "Diego Paredes",
        fecha: "15/9/2023",
        tiempoLectura: 5
      },
      {
        ...
        imagen: "/images/noticias/ganado-lechero.jpg",
        categoria: "Ganadería",
        autor: "Patricia Sosa",
        fecha: "8/9/2023",
        tiempoLectura: 6
