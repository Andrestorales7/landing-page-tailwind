    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-16 lg:grid-cols-2">
          {/* Enhanced Image Section with Overlays - MOVED DOWN with margin-top */}
          <motion.div
          ...
          {/* Content Section with Improved Typography and Layout - adjusted padding to align with image */}
          <motion.div
